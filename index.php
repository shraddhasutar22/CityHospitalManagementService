...
<head>
    ...
    <title> City Hospital management System </title>
...
.chatbot-container iframe {
    ...
    width: 100%;
    min-height: 500px;
    height: calc(100% - 110px); /* Adjust iframe height accordingly */
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">CHMS
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">City Hospital Management System</h5>
...
?>
    ...
    <div class="chatbot-container">
        <p><h1>Chat With Us Here...</h1></p>
        <hr>
    <iframe src='https://webchat.botframework.com/embed/HospitalBot-bot2?s=FP3KWFGVCfc.FGx7ijjBjhoaRL6yWdX18V2u0Ka1nL1bB7BFFUJcjVs'  style='min-width: 400px; width: 100%; min-height: 500px;'></iframe>
